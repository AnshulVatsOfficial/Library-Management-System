...
public class issueBook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ResultSet rs1 = st.executeQuery("select *from newstudent where newstudentID='"+newStudentID+"'");
                if(rs1.next()){
                    st.executeUpdate("insert into newissue values('"+bookID+"', '"+newStudentID+"', '"+issueDate+"', '"+dueDate+"', '"+returnBook+"')");
